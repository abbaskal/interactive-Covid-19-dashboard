...
if chart_select == "Country Based":
    ...
    if len(country_name_input) > 0:
        ...
        total_deaths_graph = px.line(total_deaths_graph, x='date',
                                     y='total_deaths',
                                     width=1000,
                                     color='location')  # plotly graph
        total_deaths_graph.update_layout(title="Comparision of the total deaths caused by COVID-19",
                                       xaxis=dict(title='Date'),
                                       yaxis=dict(title='The total deaths caused by COVID-19'),
        ...
        total_deaths_per_million_graph.update_layout(title="Comparision of the total deaths per million caused by COVID-19",
                                         xaxis=dict(title='Date'),
                                         yaxis=dict(title='total_deaths_per_million'),
                                         legend_title=dict(text='<b>Countries</b>')
                                         )# plotly graph
